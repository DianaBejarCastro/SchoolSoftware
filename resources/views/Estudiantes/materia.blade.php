...
<div class="container">
    ...
    <h2>REGISTRAR MATERIAS- ESTUDIANTE</h2>
...
<table class="table table-bordered">
    ...
    <tbody>
        @foreach ($data as $itemdata)
            ...
            <td><button class="btn btn-info"><a class="text-white" href="{{route('materia.storeEstudiante',[$datos->id, $itemdata->id ])}}">Registrar Materia</a></button></td>
